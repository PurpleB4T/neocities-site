...
const s_stylePath = '../styles/comment-widget.css'; // The path to the CSS file for the widget, change if you have it stored somewhere else
const s_formId = '1FAIpQLSeRdmji6IgZMehAeBQkFBXozYegcb8Y_LRQ6JRlBRyaDwO5Qg';
const s_nameId = '843869339';
const s_websiteId = '1576422875';
const s_textId = '2072730994';
const s_pageId = '1311251147';
const s_replyId = '99249807';
const s_sheetId = '156CRP8Lvb3e_PaYqSpsE-e6rBGvWoXw6IGERLFNYbok'
