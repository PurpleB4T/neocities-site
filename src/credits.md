...
permalink: about_site/credits.html
title: Credits
...
- [Virtual Observer Comment Widget](https://virtualobserver.moe/ayano/comment-widget) using Petrapixel's [Widgets for free neocities accounts](https://petrapixel.neocities.org/coding/widgets#comment-widget)
- [tamaNotchi](https://tamanotchi.world/)
- DimiDens [NavLink Ads](https://dimden.dev/navlinkads/)
- DimiDens [Moon Widget](https://dimden.dev/moonwidget/)

## Design/ Decoration
- Heavily rederenced [Petrapixel's Layout Generator](https://petrapixel.neocities.org/coding/layout-generator) for general layout as well as learning some CSS
- **Fonts**
